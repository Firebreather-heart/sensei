...
async def lifespan(app: FastAPI):
    ...
    # Startup
    print("Starting Sensei Code Sharing Platform...")
    ...
    print("Shutting down Sensei Code Sharing Platform...")
    print("Shutdown complete")



app = FastAPI(
    title="Sensei Code Sharing Platform",
    description="""
    A comprehensive code sharing platform with virtual filesystem capabilities.
